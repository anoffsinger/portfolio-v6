...
})({"fC6GB":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "866e098fa22c5dbb";
"use strict";
...
},{}],"cVcc4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var __filename = "node_modules/@splinetool/runtime/build/ui.js";
var process = require("55e71788786ce317");
var __dirname = "node_modules/@splinetool/runtime/build";
var global = arguments[3];
var Qr = ((ae)=>undefined)(function(ae) {
    ...
    var Zr = (()=>{
        ...
        return typeof __filename < "u" && (ae = ae || __filename), function(ge = {}) {
            ...
            if (zt) {
                ...
                z = Oe ? Ft.dirname(z) + "/" : __dirname + "/", Tt = (e, t)=>(e = e.startsWith("file://") ? new URL(e) : Ft.normalize(e), qt.readFileSync(e, t ? void 0 : "utf8")), rt = (e)=>(e = Tt(e, !0), e.buffer || (e = new Uint8Array(e)), e), tt = (e, t, r, i = !0)=>{
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
            ...
            var bn = {
                ...
                k: function(e, t, r, i, o, s, l, f, h, g, P, E, T) {
                    ...
                    var v = mr(P);
                    kt(v, function() {
                        Xe(`Cannot construct ${P} due to unbound types`, [
                            i
                        ]);
                    }), ue([
                        e,
                ...
                Ta: function(e, t, r, i, o, s, l) {
                    if (2 <= B.version) {
                        if (p.se) p.readPixels(e, t, r, i, o, s, l);
                        else {
                            var f = _t(s);
                ...
                ab: function(e, t, r, i, o, s, l, f, h) {
                    if (2 <= B.version) {
                        if (p.Zd) p.texImage2D(e, t, r, i, o, s, l, f, h);
                        else if (h) {
                            var g = _t(f);
                ...
                fb: function(e, t, r, i, o, s, l, f, h) {
                    if (2 <= B.version) {
                        if (p.Zd) p.texSubImage2D(e, t, r, i, o, s, l, f, h);
                        else if (h) {
                            var g = _t(f);
...
},{"55e71788786ce317":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fC6GB"], null, "parcelRequire94c2")

//# sourceMappingURL=ui.a22c5dbb.js.map
